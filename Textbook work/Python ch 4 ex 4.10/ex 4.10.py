#Exercise 4.10
"""(Guess the number) Write a scrpit that plays guess the number, do not tell the user the number until guessed.  Give the user feedback as they guess and allow user to play again"""
